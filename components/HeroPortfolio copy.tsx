            ...
            <div className="relative">
              ...
              <div className="relative w-96 h-96 rounded-3xl bg-gradient-to-br from-purple-500/20 to-blue-500/20 backdrop-blur-xl border border-white/10 flex items-center justify-center overflow-hidden group hover:scale-105 transition-transform duration-500">
               ...
               <div className="relative z-10 text-center">
                  <div className="w-60 h-60 mx-auto rounded-full bg-gradient-to-br from-purple-500 to-blue-500 flex items-end justify-center overflow-visible">
                    <div className="relative w-full h-full overflow-visible">
                      <img 
                        src="/images/Loico.png" 
                        alt="Profile" 
                        className="absolute -top-1/4 left-1/2 transform -translate-x-1/2 w-3/4 h-auto object-cover" 
                      />
                    </div>
                  </div>
                  <p className="text-slate-200 text-lg font-semibold mb-2 mt-2">{personalInfo.title.split('|')[0]}</p>
